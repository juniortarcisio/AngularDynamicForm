...
app.config(function ($routeProvider) {
    $routeProvider
    .when("/Result", {
        templateUrl: "Views/2result.html", controller: "resultCtrl"
    })
    .when("/Configuration", {
        templateUrl: "Views/3configuration.html", controller: "configurationCtrl"
    })
    .otherwise({
        templateUrl: "Views/1execution.html", controller: "executionCtrl"
    });
});
